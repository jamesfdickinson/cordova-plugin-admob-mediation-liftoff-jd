[AdMob Mediation Adapter](https://firebase.google.com/docs/admob/android/mediation-networks) for [liftoff](https://developers.google.com/admob/android/mediation/liftoff-monetize)
